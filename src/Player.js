...
export default function Player() {
  ...
  const props = useTexture({
    map: "./textures/MetalStainlessSteelBrushedElongated005_COL_2K_METALNESS.jpg",
    normalMap:
      "./textures/MetalStainlessSteelBrushedElongated005_NRM_2K_METALNESS.jpg",
    roughnessMap:
      "./textures/MetalStainlessSteelBrushedElongated005_ROUGHNESS_2K_METALNESS.jpg",
    metalnessMap:
      "./textures/MetalStainlessSteelBrushedElongated005_METALNESS_2K_METALNESS.jpg",
  });
  return (
    <RigidBody
      colliders="ball"
